...
| `payout_months` | O | smallint[] (1..12) | Geplante Ausschüttungsmonate. Leer = kein Plan. Steuert die Zuordnung einer Zahlung zum effektiven Monat in allen Auswertungen und der Eingangsliste (fälliger geplanter Monat, ein Monat Vorlauf für vorgezogene Zahlungen, inkl. Jahresverschiebung — CALCULATION_RULES.md §10). Ändert das echte `pay_date` der Zahlungen nicht |
