...
describe("5) DELETE auf fachlichen Tabellen ist gesperrt (auch fuer eigene Zeilen)", () => {
  it("A kann seine eigene Zahlung nicht loeschen (kein DELETE-Grant, Least Privilege)", async () => {
    await expect(
      asUser(userA, (client) =>
