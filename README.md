...
| Bereich | Stand |
|---|---|
| Anmeldung, Depotkonten, Depot (Assets und Entwicklung) | in Betrieb |
...
| Depotstand (Bestand, Marktwert und erwartete Ausschüttung aus dem DivvyDiary-Portfolio-Export) | neu; Migrationen 0029 bis 0031 müssen eingespielt werden ([docs/PORTFOLIO_IMPORT.md](docs/PORTFOLIO_IMPORT.md)) |
